...
$stmt = $conn->prepare("
    SELECT a.*, u.fullname AS patient_id
    FROM appointments a
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($update->execute()) {
        ...
        <div style='text-align:center; margin-top:100px; font-family:Segoe UI;'>
            ...
            <a href='doctor_appointments.php' class='btn btn-success' style='margin:10px;'>📅 My Appointments</a>
            <a href='doctor_patients.php' class='btn btn-info' style='margin:10px;'>👥 My Patients</a>
            <a href='doctor_dashboard.php' class='btn btn-secondary' style='margin:10px;'>🏠 Dashboard</a>
        </div>
  ...
  <div class="card p-4">
    ...
    <form method="POST">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?= htmlspecialchars($appointment['patient_id']) ?>" disabled>
      </div>
    ...
    <div class="text-center">
      ...
      <a href="doctor_patients.php" class="btn btn-primary">👥 My Patients</a>
    </div>
  </div>
</div>
